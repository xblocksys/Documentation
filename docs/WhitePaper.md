...
<!--
X.Blockchain 의 제안은 전자문서의 효율적 관리로 부터 출발한 것은 사실 이지만, 단순히 전자 문서만을 위한 블록체인 플랫폼은 아니다. 불필요한 블록들을 제거하고 오직 자신만의 블록들로 구성된 블록체인을 구성 하면서 동시에 Public Blockchain 과 동일한 수준의 '탈중앙화' 와 '분산성'을 획득하고자 하는 요구를 만족 시킬 수 있는 블록체인 플랫폼이다.
-->
